...
class Unit extends MapObject
{
    ...
    Unit(Faction _faction, Image _portriat)
    {
        ...
        {
            setImage(new Image(new File("CRYSTAL_UNIT.png").toURI()
                                       .toString()));
        }
        if ( _faction.id == FactionEnum.FORESTMEN )
        {
            setImage(new Image(new File("FOREST_UNIT.png").toURI()
                                       .toString()));
        }
        if ( _faction.id == FactionEnum.SKYMEN )
        {
            setImage(new Image(new File("FLYING_UNIT.png").toURI()
                                       .toString()));
        }
...
class HQ extends MapObject
{
    ...
    HQ(Faction _faction, Image _portriat)
    {
        if ( _faction.id == FactionEnum.CRYSTALMEN )
        {
            setImage(new Image(new File("CRYSTAL_HQ.png").toURI()
                                       .toString()));
        }
        if ( _faction.id == FactionEnum.FORESTMEN )
        {
            setImage(new Image(new File("FOREST_HQ.png").toURI()
                                       .toString()));
        }
        if ( _faction.id == FactionEnum.SKYMEN )
        {
            setImage(new Image(new File("FLYING_HQ.png").toURI()
                                       .toString()));
        }
        this.faction  = _faction;
        this.portriat = _portriat;
...
class Board
{
    ...
    {
        if ( destinationTile.obj == null && selectedTile.obj.getClass()
                .equals(Unit.class) )
        {
    ...
    void addUnit(Faction faction, int i, int j)
    {
        ...
        if ( faction.id == FactionEnum.SKYMEN )
        {
            unit = new Unit(faction,
                            new Image(new File("FLYING_UNIT_PORTRAIT.png").toURI()
                                              .toString()));
        }
        else if ( faction.id == FactionEnum.CRYSTALMEN )
        {
            unit = new Unit(faction,
                            new Image(new File("CRYSTAL_UNIT_PORTRAIT.png").toURI()
                                              .toString()));
        }
        else
        {
            unit = new Unit(faction,
                            new Image(new File("TREE_UNIT_PORTRAIT.png").toURI()
                                              .toString()));
        }
    ...
    void addHQ(Faction faction, int i, int j)
    {
        ...
        mapTiles.get(i)
                .get(j).hex.setImage(new Image(new File("hexagon.png").toURI()
                                                       .toString()));
        mapTiles.get(i)
                .get(j)
                .setOwner(faction.pl);
        ...
        {
            hq = new HQ(faction,
                        new Image(new File("flying_meteor.png").toURI()
                                          .toString()));
        }
        else if ( faction.id == FactionEnum.CRYSTALMEN )
        {
            hq = new HQ(faction,
                        new Image(new File("crystal_meteor.png").toURI()
                                          .toString()));
        }
        else
        {
            hq = new HQ(faction,
                        new Image(new File("forest_meteor.png").toURI()
                                          .toString()));
        }
    ...
    {
        Faction faction = mapTiles.get(i)
                .get(j).obj.faction;
        ...
        GameInfo.removeHQ(mapTiles.get(i)
                                  .get(j));
