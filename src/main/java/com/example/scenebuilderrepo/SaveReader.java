...
class SaveReader
{
    ...
    ArrayList<HexStruct> getHexList()
    {
        ...
        for (int j = 0; j < hexList.getLength(); j++)
        {
            ...
            hexagon.x = Integer.parseInt(hex.getElementsByTagName("x")
                                                 .item(0)
                                                 .getTextContent());
            hexagon.y = Integer.parseInt(hex.getElementsByTagName("y")
                                                 .item(0)
                                                 .getTextContent());
            String obj = hex.getElementsByTagName("obj")
                    .item(0)
                    .getTextContent();
            if ( obj != null )
            {
                object.actionPointMax  = Integer.parseInt(hex.getElementsByTagName("actionPointsMax")
                                                                  .item(0)
                                                                  .getTextContent());
                object.actionPointCurr = Integer.parseInt(hex.getElementsByTagName("actionPointsCurr")
                                                                  .item(0)
                                                                  .getTextContent());
                object.hpCurrent       = Integer.parseInt(hex.getElementsByTagName("hpCurrent")
                                                                  .item(0)
                                                                  .getTextContent());
                object.hpMax           = Integer.parseInt(hex.getElementsByTagName("hpMax")
                                                                  .item(0)
                                                                  .getTextContent());
                object.atk             = Integer.parseInt(hex.getElementsByTagName("attack")
                                                                  .item(0)
                                                                  .getTextContent());
                object.def             = Integer.parseInt(hex.getElementsByTagName("defense")
                                                                  .item(0)
                                                                  .getTextContent());
            }
            else
            ...
            if ( !hex.getElementsByTagName("tileOwner")
                    .item(0)
                    .getTextContent()
                    .equals("null") )
            {
                hexagon.faction = FactionEnum.valueOf(hex.getElementsByTagName("tileOwner")
                                                              .item(0)
                                                              .getTextContent());
            }
            hexagon.imageFilename = hex.getElementsByTagName("imagefilename")
                    .item(0)
                    .getTextContent();
            hexagon.obj           = object;
