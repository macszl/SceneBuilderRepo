...
public class RaceSelect implements Initializable {
    ...
    Faction crystal=new Faction(1,Purple);
    Faction tree=new Faction(2,Brown);
    Faction sky=new Faction(3,Blue );
    @FXML
    private Button bl1;
