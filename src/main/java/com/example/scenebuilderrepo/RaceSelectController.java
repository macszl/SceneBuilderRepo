...
class RaceSelectController implements Initializable
{
    ...
    public Image arrowImage      = new Image(new File("ARROW.png").toURI()
                                                     .toString());
    public Image clickarrowImage = new Image(new File("ARROWCLICK.png").toURI()
                                                     .toString());
    public Image greyarrowImage  = new Image(new File("ARROWGREY.png").toURI()
                                                     .toString());
    public Image bg              = new Image(new File("raceSelectBG.png").toURI()
                                                     .toString());
    ...
    void setImg(int p)
    {
        if ( p == 1 )
        {
            ...
            if ( im1 == 0 )
            {
                GameInfo.playerFactions.set(0, crystal);
            }
            if ( im1 == 1 )
            {
                GameInfo.playerFactions.set(0, tree);
            }
            if ( im1 == 2 )
            {
                GameInfo.playerFactions.set(0, sky);
            }
        }
        if ( p == 2 )
        {
            ...
            if ( im2 == 0 )
            {
                GameInfo.playerFactions.set(1, crystal);
            }
            if ( im2 == 1 )
            {
                GameInfo.playerFactions.set(1, tree);
            }
            if ( im2 == 2 )
            {
                GameInfo.playerFactions.set(1, sky);
            }
        }
        if ( p == 3 )
        {
            ...
            if ( im3 == 0 )
            {
                GameInfo.playerFactions.set(2, crystal);
            }
            if ( im3 == 1 )
            {
                GameInfo.playerFactions.set(2, tree);
            }
            if ( im3 == 2 )
            {
                GameInfo.playerFactions.set(2, sky);
            }
        }
        checkSelect();
    }
    ...
    {
        imgs.add(new Image(new File("CRYSTAL_HQ.png").toURI()
                                   .toString()));
        imgs.add(new Image(new File("FOREST_HQ.png").toURI()
                                   .toString()));
        imgs.add(new Image(new File("FLYING_HQ.png").toURI()
                                   .toString()));
